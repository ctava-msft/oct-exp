    ...
    def setup(self, stage=None):
        ...
        for cube_name in self.train_cube_names:
            ...
            for img_name in img_names:
                ...
                train_latent_paths.append(os.path.join(self.latent_root, cube_name))
        test_paths = []
        test_latent_paths = []
...
class img_latent_Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # latent = torch.load(self.latent_paths[index], map_location=torch.device('cpu'))
        ...
        return {'image': img, 'pre_image': pre_img, 'img_path': self.img_paths[index],
